...
//extern volatile unsigned short a2dCompleteFlag;
// wird im interrupt auf 1 gesetzte wenn alle daten aktualisiert wurden
extern volatile unsigned short a2dIntFlag;


#ifdef OVERSAMPLING
extern unsigned short	a2dBuf[A2D_SCAN_CHANNELS+1];
extern unsigned short  a2dChan[A2D_SCAN_CHANNELS+1];
#else
#ifdef ADS7822
extern unsigned short	a2dBuf[A2D_SCAN_CHANNELS+1][A2D_SCAN_BUF];
#else
extern unsigned short	a2dBuf[A2D_SCAN_CHANNELS][A2D_SCAN_BUF];
#endif

#endif
//volatile extern unsigned char	a2dIndex,a2dChannel;
...
//#define bits2uout bits2iout
#define bits2uout BITS2UOUT
#define bits2iout BITS2IOUT
/*
s16 bits2iout(s16 x);
*/
s16 BITS2IOUT_A(s16 x);
s16 BITS2IOUT_mA(s16 x);
s16 BITS2UOUT_V(s16 x);
s16 BITS2UOUT_mV(s16 x);
#endif
